...
export const ServicesSection = () => {
  return (
    <section aria-label="Cybernaut services" className="py-8 text-white lg:py-12">
      <div className="container">
        <div className="mx-auto max-w-5xl text-center">
          <p className="mb-4 text-xl font-extralight uppercase text-[var(--skyBlue)]">
            Our Services
          </p>
        ...
        <div className="services-mobile-slider mt-12">
          <Swiper slidesPerView={1.2} spaceBetween={24} className="!overflow-visible">
